package com.dldhk97.mgji_menu.viewholders;
        ...
        try{
            ...
            if(pos != RecyclerView.NO_POSITION){
                if(toggle){
                    ...
                    textView_sensorName.setTextColor(ColorHandler.getInstance().getSensorNameColorId());
                    textView_sensorType.setTextColor(ColorHandler.getInstance().getSensorTypeColorId());
                    item_cl.setBackgroundColor(ColorHandler.getInstance().getBackgroundColorId());
                }
                toggle = !toggle;
            }
        }
